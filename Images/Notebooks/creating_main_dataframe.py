...
# #### By Colin Werkhoven and Ali Safdari
...
# #### Function By Colin Werkhoven & Ali Safdari
...
# ### This function is creating the final dataframe that is used for the MET regression models
# 
# All respondents and activities are looped over and added to the final dataframe.
# 
# Function By Colin Werkhoven & Ali Safdari
...
def get_regression_df(correspondent, addHeader):
    ...
    for activity in activities:
        ...
        # Getting the start and ending time of the activity performed in the lab
        start, stop = get_timestamps(correspondent, activity)

        # Features were taken and created from the Vyntus and Raw file
        # Here we have the data from those files
        ...
        # Adding the features to a CSV file with all the respondent data/features
