...
walking_df = all_df.loc[all_df['activity'] == 'staan']
walking_df.head()
...
all_df = all_df.loc[all_df['mean_met'] < 3]
...
# X = all_df[['sum_mag_acc', 'weight_kg', 'length_cm', 'age_category',
