...
cycling_df = all_df.loc[all_df['activity'] == 'fietsen licht']
...
# X = all_df[['sum_mag_acc', 'weight_kg', 'length_cm', 'age_category', 'meets_balance_guidelines', 'mean_speed']]
...
xgbr = xg.XGBRegressor(n_estimators=optimal_estimators, objective='reg:linear', random_state=0)
